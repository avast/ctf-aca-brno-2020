...
void ch_radio_start(unsigned long tick)
{
  ...
  tft->pushImage(128-64, 77-64,  128,128, img_antenna);
...
void ch_radio_update(unsigned long tick)
{
  TFT_eSPI* tft= disp_getiface();
...
void ch_radio_input(char* command)
{
